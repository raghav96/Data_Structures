...
/*                                                                                                                                                                                                              
 * Load the words in the file into the  trie
 */
void Utils::load_dict(Trie& dict, istream& words)
{
  unsigned int freq;
  string data = "";
  string temp_word = "";
...
/*                                                                                                                                                                                                              
 * Load num_words from words stream into the  trie
 */
void Utils::load_dict(Trie& dict, istream& words, unsigned int num_words)
{
  unsigned int freq;
  string data = "";
  string temp_word = "";
